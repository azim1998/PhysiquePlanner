...
IF NOT EXISTS (SELECT 1 FROM Muscle WHERE Id = 1)
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM Exercise WHERE Id = 1)
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM ExerciseMuscle WHERE ExerciseId = 1 AND MuscleId = 1)
BEGIN
